(function() {
     ...
     */
    CheckerToolkit.prototype.doStandardCheckFromUrlList = function (list, notice_en) {
        
        if(typeof(notice_en) == 'undefined'){
            notice_en = false;
        }
        ...
        var launchTestOnUrl = function () {
            var phpError = context.evaluate(currentCheck.getPhpErrors, notice_en),
                errBefore,
                errAfter,
                captureFilename;
     ...
     * @return array res
     */
    CheckerToolkit.getPhpErrors = function (notice_en) {
        ...
        if (document.body) {
            ...
            if (notice_en && document.body.innerHTML.indexOf('Notice') !== -1) {
