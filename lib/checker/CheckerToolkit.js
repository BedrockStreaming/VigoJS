(function() {
     ...
     */
    CheckerToolkit.prototype.doStandardCheckFromUrlList = function (list) {
        ...
        var launchTestOnUrl = function () {
            var phpError = casper.evaluate(currentCheck.getPhpErrors),
                errBefore,
                errAfter,
                captureFilename;
     ...
     * @return array res
     */
    CheckerToolkit.getPhpErrors = function () {
        var res = [];
        if (document.body) {
